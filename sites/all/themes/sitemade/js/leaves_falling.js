...
Leaf1 =new Image();
Leaf1 = allTypeOfLeaves[0] = "http://шопоголики-64.рф/sites/all/themes/zen/sitemade/images/leaf.png";//path to the image you will use
Leaf2 =new Image();
Leaf2 = allTypeOfLeaves[1] ="http://шопоголики-64.рф/sites/all/themes/zen/sitemade/images/leaf1.png";//you can have up to 3 different kind of leaves
Leaf3 =new Image();
Leaf3 = allTypeOfLeaves[2] ="http://шопоголики-64.рф/sites/all/themes/zen/sitemade/images/leaf2.png";//possible to add more
...
var size = 30;//general size of leaves, final size is calculated randomly (with this number as general parameter)
...
function fallingLeaves(){	
	...
	setTimeout(function(){
    fallingLeaves();
  }, 50);//function time out - fps of leaves
